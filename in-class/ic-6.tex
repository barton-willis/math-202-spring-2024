...
$A(y) = y^4$ and $B(x) = -x^2 + c$, where $c \in \reals$. So a GS to the DE is
\begin{equation}
 y^4 = -x^2 + c.
\end{equation}
Another GS is 
...
\begin{solution}[2.5in]
We need to paste $y=2$ and $x=1$ into a GS. That gives
\begin{equation}
    2^4 = -1^2 + c.
   \end{equation}
so $c = 17$.
...
\begin{solution}%[2.5in]
\includegraphics*[scale=0.2]{desmos-graph(74).png}
\end{solution}
