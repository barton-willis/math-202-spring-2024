...
\begin{flushleft}
  \large
\textbf{\Numberstringnum{57} Questions for Dr.\ Willis} \\
\emph{Updated \today}
\end{flushleft}  
\normalsize
%\subsubsection*{FAQ}
...
\textbf{Answer} Maybe. Giving guidelines on what it means to 
  ...
  to simplify all vanishing sub expressions to zero (for example, 
...
\item  \textbf{Question}  Will you give us a review before every midterm exam?
...
\item  \textbf{Question}  Can a function be infinity?
 ...
 \item \textbf{Question} Since $\int x^3 \, \mathrm{d}x = \frac{1}{4} x^4$,
  it follows that $\int \cos(\theta)^3 \, \mathrm{d} \theta = \frac{1}{4} \cos(\theta)^4$, right?
...
But to match the integrands $x$ and $\cos(\theta)^3$, we need to match $x$ with $\cos(\theta)$.
We can't simultaneously match $x$ with both $\theta$ and with $\cos(\theta)$.
...
\item \textbf{Question} To prove that an equation is an identity, I was
 ...
 \textbf{Answer} To prove that an equation is an identity,
...
\item  \textbf{Question} Is it true that \(1 + 2 + 3 + \cdots = -1/12\)?
  ...
  \textbf{Answer}  Maybe. For one meaning of convergence, the answer is yes; for other meanings, including the 
  meaning that you will learn (or learned)  in calculus, the answer 
  is no.  Some physical theories use the notion of convergence 
  for which it is true that \(1 + 2 + 3 + \cdots = -1/12\).
...
\item \textbf{Question} Were most of these questions asked in private
 or in class? 

 \textbf{Answer} It's about half-and-half, I think.

\item  \textbf{Question} Has somebody really asked all these questions?
 
\textbf{Answer} Yes all these questions, even including this question, have been.
